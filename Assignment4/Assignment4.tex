...
\usepackage{graphicx}
\graphicspath{ {/user/Neha Rani/desktop} }
%\usepackage{amssymb}
%\usepackage{relsize}
...
\begin{lstlisting}
https://github.com/neharani289/EE14014/tree/master/Assignment_4
\end{lstlisting}
\section{Problem}
In $\triangle{ABC}$, the bisector $\vec{AD}$ of \angle{A}
is   
...
\caption{Isoceles Triangle with $\vec{AD}$  $\perp$ $\vec{BC}$}
\label{myfig}
\end{figure}
Since line BC is perpendicular to line AD the inner product is zero.  
\begin{align}
